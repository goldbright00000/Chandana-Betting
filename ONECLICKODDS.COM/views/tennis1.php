...
$url = $tmp_odds_url = (count($uri_array) > 1) ? $odds_url.$_GET['q'] : $odds_url."tennis/mens-rogers-cup";
?>
...
<?php 
$url_collection = get_url_collection('http://www.oddschecker.com/tennis/mens-rogers-cup');
