  		...
  		<div class="container-fluid">
    		<ul class="nav navbar-nav">
				...
				<li <?php echo in_array('championship', $uri_array) ? 'class="active"' : '' ?>><a href="<?php echo $base_url ?>/football/english/championship">Championship</a></li>
			  	...
			  	<!-- <li <?php echo (in_array('FINDIT', $uri_array)) ? 'class="active"' : '' ?>><a href="<?php echo $base_url ?>/football/FINDIT" onclick="myFunction()">Find the Matches</a></li> -->
			  	<li <?php echo (in_array('FINDIT', $uri_array)) ? 'class="active"' : '' ?>><a href="<?php echo $base_url ?>/football/FINDIT1/going">Find the Matches</a></li>
			</ul>
		</div>
	</nav>
...
// 	$('.modal-content').css("display", "block");// body...
// }
