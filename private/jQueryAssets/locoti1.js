...
function resetRegisterMessages(){
	...
	var t = document.getElementById("packery_base1");
...
function resetTileColor() {
	...
	var surebetTiles = packery_base1.getElementsByClassName("sbet_main_element");
	var calculatorTiles = packery_base1
...
function setSB_gimmic_rlt(objId, startState, additional_title) {
	...
	var vec = packery_base1.getElementsByClassName("gimmic_text link_user_text");
	for (var i = 0; i < vec.length; i++)
		vec[i].textContent = "locoti.com/index.php?aff=" + userId;
...
function setSB_gimmic_best_surebet(best_surebet) {
	...
	packery_base1.appendChild(element);
...
function initiate_login(obj) {
	...
	if (isStopped)
		packery_base1.getElementsByClassName("stop_button")[0].textContent = "Start Timer";
	else
		packery_base1.getElementsByClassName("stop_button")[0].textContent = "Stop Timer";
...
function initiate_logout() {
	...
	var vec = packery_base1.getElementsByClassName("link_user_text");
	for (var i = 0; i < vec.length; i++)
		vec[i].textContent = "locoti.com/index.php?aff=userId";
...
function handleRequest(data) {
	...
	var timeImage = packery_base1.getElementsByClassName("timer_image")[0];
...
function initPackery() {
	...
	var container = document.querySelector('.packery1');
...
function doTimerAction() {
	...
	isStopped = !isStopped;
	var element = packery_base1.getElementsByClassName("stop_button")[0];
...
docReady(function() {
	...
	packery_base1 = document.getElementById("packery_base1");
